...
def main(config: ConfigParser):
    ...
    out_path = os.path.join(os.getcwd(), 'history.npz')
    np.savez(
       out_path,
       train_loss     = np.array(trainer.epoch_train_loss),
       test_loss      = np.array(trainer.epoch_test_loss),
       train_acc_top1 = np.array(trainer.epoch_train_acc_top1),
       train_acc_top5 = np.array(trainer.epoch_train_acc_top5),
       test_acc_top1  = np.array(trainer.epoch_test_acc_top1),
       test_acc_top5  = np.array(trainer.epoch_test_acc_top5),
    )
    print(f"[TRAIN] history saved to: {out_path}")
