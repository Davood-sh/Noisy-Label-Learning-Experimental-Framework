...
class Trainer(BaseTrainer):
    ...
    def __init__(self, model, reparametrization_net, train_criterion, metrics, optimizer, optimizer_loss, config, data_loader,
        ...
        self.epoch_train_acc_top1  = []
        self.epoch_train_acc_top5  = []
        self.epoch_test_acc_top1   = []
        self.epoch_test_acc_top5   = []
    ...
    def _train_epoch(self, epoch):
        ...
        # start timer for this epoch’s training
        t0 = time.time()
        ...
        log = {
            ...
            'training_time':  round(training_time, 3),   # added
        }
        ...
        epoch_train_loss     = total_loss / self.len_epoch
        epoch_train_metrics  = total_metrics / self.len_epoch
        self.epoch_train_loss.append(epoch_train_loss)
        self.epoch_train_acc_top1.append(epoch_train_metrics[0])
        self.epoch_train_acc_top5.append(epoch_train_metrics[1])
    ...
    def _test_epoch(self, epoch):
        ...
        epoch_test_loss     = total_test_loss / len(self.test_data_loader)
        epoch_test_metrics  = total_test_metrics / len(self.test_data_loader)
        self.epoch_test_loss.append(epoch_test_loss)
        self.epoch_test_acc_top1.append(epoch_test_metrics[0])
        self.epoch_test_acc_top5.append(epoch_test_metrics[1])

        return {
            'test_loss': total_test_loss / len(self.test_data_loader),
            'test_metrics': (total_test_metrics / len(self.test_data_loader)).tolist(),
            'inference_time': round(inference_time, 3)   # added
        }
