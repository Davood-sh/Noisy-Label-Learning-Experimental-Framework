...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        self.writer.add_scalar('train_time', train_time, epoch)
    ...
    def _test_epoch(self, epoch):
        ...
        # stop timer and compute inference duration
        inference_time = time.time() - t0    

        # build the log dict exactly as before, plus our new key
        log = {
